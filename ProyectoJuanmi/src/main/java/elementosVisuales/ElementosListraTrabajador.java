...
/**
 * Clase que extiende de JPanel y es una lista de los trabajadores de la empresa
 * 
 * @author Juanmi
 *
 */
public class ElementosListraTrabajador extends JPanel {
	/** ventana sobre la que aparece la lsita **/
	private Ventana ventana;
	/** trabajador del que se mostrara la informacion **/
	private Trabajador trabajador;

	/**
	 * Constructor que crea una lista de trabajadores, con los registros de los
	 * trabajadores y se muestran automaticamente. * Tambien contiene todas las
	 * propiedades de dicha lista
	 * 
	 * @param v  ventana en la que aparece la lista
	 * @param tr trabajador del que mostraremos la informacion
	 */
	public ElementosListraTrabajador(Ventana v, final Trabajador tr) {
		...
		botonBorrar.addMouseListener(new MouseAdapter() {
			@Override
			/**
			 * Funcion que al clicar en el boton borrar se borra un trabajador de la lista y
			 * de la base de datos
			 * 
